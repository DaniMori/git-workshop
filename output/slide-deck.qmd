...
Note that Rstudio fills in the folder name for you automatically; you don't need
to create a new folder to "nest" your repository into it, it will create it
...
of your choice, or BETTER, change the name of the existing folder.
...
There are a few files and folders that we don't have time to explore in detail.
Just to let you know, they implement some usually recommended "best practice"
features in R and Rstudio projects that will save you time and headaches in the
future.
...
of the environment, with their versions.
:::
...
Why "discard chunk" option...? Rstudio should drop this feature (IMO)
...
-   Use the `SHIFT` key to select several lines (watch out with "selection", it
